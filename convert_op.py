...
create_jsonl(original_posts_train, 'finetune_llama3/finetune_datasets/op_train_alpaca.jsonl', instruction)
create_jsonl(original_posts_test, 'finetune_llama3/finetune_datasets/op_test_alpaca.jsonl', instruction)
